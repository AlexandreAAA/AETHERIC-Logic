...
namespace EveController
{
    ...
    public class UpdateAnimatorWithMousePosition : StateAction
    {
        ...
        public override void Execute(StateController controller)
        {
            ...
            if(controller.mouvementVariable.moveDirection.sqrMagnitude > 0)
            {
                ...
                forwardBackwardsMagnitude *= controller.mouvementVariable.moveAmount;
                ...
                rightLeftMagnitude *= controller.mouvementVariable.moveAmount;
